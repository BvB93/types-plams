...
class CRSResults(SCMResults):
    ...
    @overload
    def get_sigma_profile(self, subsection: str = ..., unit: str = ..., as_df: Literal[False] = False) -> Dict[str, np.ndarray]: ...
    @overload
    def get_sigma_profile(self, subsection: str = ..., unit: str = ..., as_df: Literal[True] = False) -> pd.DataFrame: ...  # type: ignore[assignment]
    @overload
    def get_sigma_potential(self, subsection: str = ..., unit: str = ..., as_df: Literal[False] = False) -> Dict[str, np.ndarray]: ...
    @overload
    ...
    def plot(self, *arrays: np.ndarray, x_axis: Union[None, str, Sequence[Any], np.ndarray] = ..., plot_fig: bool = ..., x_label: Optional[str] = ..., y_label: Optional[str] = ...) -> Figure: ...

...
class AMSResults(Results):
    ...
    def get_history_property(
        self, varname: str, history_section: str = ...
    ) -> List[Any]: ...
    def get_property_at_step(
        self, step: int, varname: str, history_section: str = ...
    ) -> Any: ...
    ...
    def get_gradients(
        self, energy_unit: str = ..., dist_unit: str = ..., engine: Optional[str] = ...
    ) -> np.ndarray: ...
    ...
    def get_frequencies(
        self, unit: str = ..., engine: Optional[str] = ...
    ) -> np.ndarray: ...

...
def from_smiles(  # type: ignore[misc]
    smiles: str, nconfs: L[1] = ..., name: None | str = ..., forcefield: L[None, "uff", "mff"] = ..., rms: float = ...
) -> Molecule: ...
@overload
def from_smiles(
    smiles: str, nconfs: int, name: None | str = ..., forcefield: L[None, "uff", "mff"] = ..., rms: float = ...
) -> list[Molecule]: ...
@overload
def from_smarts(  # type: ignore[misc]
    smarts: str, nconfs: L[1] = ..., name: None | str = ..., forcefield: L[None, "uff", "mff"] = ..., rms: float = ...
) -> Molecule: ...
@overload
def from_smarts(
    smarts: str, nconfs: int, name: None | str = ..., forcefield: L[None, "uff", "mff"] = ..., rms: float = ...
) -> list[Molecule]: ...
@overload
...
def from_sequence(  # type: ignore[misc]
    sequence: str, nconfs: L[1] = ..., name: None | str = ..., forcefield: L[None, "uff", "mff"] = ..., rms: float = ...
) -> Molecule: ...
@overload
def from_sequence(
    sequence: str, nconfs: int, name: None | str = ..., forcefield: L[None, "uff", "mff"] = ..., rms: float = ...
) -> list[Molecule]: ...
...
@overload
def readpdb(
    pdb_file: str | os.PathLike[str] | IO[str], removeHs: bool = ..., proximityBonding: bool = ..., return_rdmol: L[False] = ...
) -> Molecule: ...
@overload
def readpdb(
...
@overload
def add_Hs(mol: Chem.Mol | Molecule, forcefield: L[None, "uff", "mff"] = ..., return_rdmol: L[False] = ...) -> Molecule: ...
@overload
def add_Hs(mol: Chem.Mol | Molecule, forcefield: L[None, "uff", "mff"] = ..., return_rdmol: L[True] = ...) -> Chem.Mol: ...
@overload

...
class Cp2kResults(Results):
    ...
    @overload
    def get_mulliken_charges(self, return_spin: Literal[False] = ..., index: int = ...) -> Union[float, List[float]]: ...
    @overload
    def get_mulliken_charges(self, return_spin: Literal[True], index: int = ...) -> Union[Tuple[float, float], Tuple[List[float], List[float]]]: ...
    @overload
    def get_hirshfeld_charges(self, return_spin: Literal[False] = ..., index: int = ...) -> Union[float, List[float]]: ...
    @overload
    def get_hirshfeld_charges(self, return_spin: Literal[True], index: int = ...) -> Union[Tuple[float, float], Tuple[List[float], List[float]]]: ...
...
def Cp2kSettings2Mol(settings: Settings) -> Optional[Molecule]: ...

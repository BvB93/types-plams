...
def cell_shape(lattice: Sequence[Sequence[float]] | np.ndarray) -> list[Any]: ...
def cell_lengths(lattice: Sequence[Sequence[float]] | np.ndarray, unit: str = ...) -> list[float]: ...
def cell_angles(lattice: Sequence[Sequence[float]] | np.ndarray, unit: str = ...) -> list[np.float_]: ...
def cellvectors_from_shape(box: Sequence[float] | np.ndarray) -> list[float]: ...

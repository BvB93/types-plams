...
class Molecule(Sized, Iterable[Atom]):
    ...
    def add_atom(self, atom: Atom, adjacent: Optional[Iterable[Atom]] = ...) -> None: ...
    ...
    def guess_bonds(self, atom_subset: Optional[Sequence[Atom]] = ..., dmax: float = ...) -> None: ...
    ...
    @overload
    def index(self, value: Atom, start: int = ..., stop: Optional[int] = ...) -> int: ...
    @overload
    def index(self, value: Bond, start: int = ..., stop: Optional[int] = ...) -> Tuple[int, int]: ...
    @overload
    def round_coords(self, decimals: int = ...) -> Molecule: ...
    @overload
    ...
    @overload
    def distance_to_mol(self, other: Molecule, result_unit: str = ...) -> float: ...
    @overload
    def distance_to_mol(self, other: Molecule, result_unit: str = ..., return_atoms: Literal[False] = ...) -> float: ...
    @overload
    def distance_to_mol(self, other: Molecule, result_unit: str = ..., return_atoms: Literal[True] = ...) -> Tuple[float, Atom, Atom]: ...
    ...
    def perturb_atoms(self, max_displacement: float = ..., unit: str = ..., atoms: Optional[Iterable[Atom]] = ...) -> None: ...
    def perturb_lattice(self, max_displacement: float = ..., unit: str = ..., ams_convention: bool = ...) -> None: ...
    def substitute(self, connector: Union[Bond, Tuple[Atom, Atom]], ligand: Molecule, ligand_connector: Union[Bond, Tuple[Atom, Atom]], bond_length: Optional[float] = ..., steps: int = ..., cost_func_mol: Optional[Callable[[Molecule, Molecule], float]] = ..., cost_func_array: Optional[Callable[[np.ndarray, np.ndarray], float]] = ...) -> None: ...
    ...
    def __array__(self, dtype: Union[None, str, type, np.dtype] = ...) -> np.ndarray: ...
    ...
    _readformat: Dict[str, Callable[..., Union[None, PDBHandler]]]

...
class Molecule:
    ...
    def __init__(
        ...
        positions: None | npt.ArrayLike = ...,
        numbers: None | Collection[int] = ...,
        lattice: None | npt.ArrayLike = ...,
        **other: Any,
    ) -> None: ...
    ...
    def bond_matrix(self) -> npt.NDArray[np.float64]: ...
    ...
    def rotate_lattice(self, matrix: npt.ArrayLike) -> None: ...
    def rotate(self, matrix: npt.ArrayLike, lattice: bool = ...) -> None: ...
    ...
    def apply_strain(self, strain: npt.ArrayLike, voigt_form: bool = ...) -> None: ...
    ...
    def substitute(
        ...
        cost_func_array: None | Callable[[npt.NDArray[np.float64], npt.NDArray[np.float64]], float | np.float64] = ...,
    ) -> None: ...
    ...
    def as_array(self, atom_subset: None | Iterable[Atom] = ...) -> npt.NDArray[np.float64]: ...
    def from_array(
        self,
        xyz_array: Molecule | Iterable[tuple[float, float, float]] | npt.NDArray[np.float64],
        atom_subset: None | Iterable[Atom] = ...,
    ) -> None: ...
    def __array__(self, dtype: Any = ...) -> npt.NDArray[np.float64]: ...
    ...
    @overload
    @staticmethod
    def rmsd(mol1: Molecule, mol2: Molecule, *, return_rotmat: L[False] = ..., check: bool = ...) -> npt.NDArray[np.float64]: ...
    @overload
    @staticmethod
    def rmsd(
        mol1: Molecule, mol2: Molecule, *, return_rotmat: L[True], check: bool = ...

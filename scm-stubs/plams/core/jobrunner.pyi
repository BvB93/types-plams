...
class JobRunner(Generic[_BST], metaclass=_MetaRunner):
    ...
    def call(self, runscript: str, workdir: str, out: str, err: str, runflags: Settings) -> int: ...
...
class GridRunner(JobRunner[_BST]):
    ...
    def __new__(  # type: ignore[misc]
        cls, grid: Settings | L["auto", "pbs", "slurm"] = ..., sleepstep: int = ..., parallel: bool = ..., maxjobs: L[0] = ...
    ) -> GridRunner[None]: ...
    @overload
    def __new__(
        cls, grid: Settings | L["auto", "pbs", "slurm"] = ..., sleepstep: int = ..., parallel: bool = ..., maxjobs: int = ...
